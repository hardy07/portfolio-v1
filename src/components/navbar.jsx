          ...
          <div className="hidden md:flex items-center justify-between w-full">
            <div className="font-mono text-sm flex gap-14">
              ...
              <ScrollLink
                ...
                to="Qualifications"
                smooth={true}
                offset={-120} // Adjust this value to control the scroll offset
                duration={500}
              >
                /qualifications
              </ScrollLink>
              <ScrollLink
                ...
                to="Technologies"
                smooth={true}
                offset={-170} // Adjust this value to control the scroll offset
                duration={500}
              >
                /technologies
              </ScrollLink>
              <ScrollLink
                ...
                to="Projects"
                smooth={true}
                offset={-110} // Adjust this value to control the scroll offset
                duration={500}
              >
                /projects
              </ScrollLink>
              ...
              <ScrollLink
                ...
                to="AreasofInterest"
                smooth={true}
                offset={15} // Adjust this value to control the scroll offset
                duration={500}
              >
                /areas of Expertise
              </ScrollLink>
